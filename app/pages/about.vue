        ...
        <div class="p-8 space-y-6">
          ...
          <div>
            ...
            <p class="leading-relaxed" style="color: var(--text-secondary);">
              我们致力于提供专业、便捷、私密的心理健康测评服务，帮助更多人了解自己的心理状态，
          ...
          <div>
            ...
            <div class="grid grid-cols-2 md:grid-cols-3 gap-3">
              <div class="tech-card p-3 rounded-lg" style="background-color: var(--bg);">
                <div class="flex items-center gap-2">
                  <span class="text-xl">🟢</span>
                  <div>
                    <div class="font-semibold" style="color: var(--text);">Nuxt.js 4</div>
                    <div class="text-xs" style="color: var(--text-muted);">Vue.js 框架</div>
                  </div>
                </div>
              </div>
              <div class="tech-card p-3 rounded-lg" style="background-color: var(--bg);">
                <div class="flex items-center gap-2">
                  <span class="text-xl">💚</span>
                  <div>
                    <div class="font-semibold" style="color: var(--text);">Vue 3</div>
                    <div class="text-xs" style="color: var(--text-muted);">渐进式框架</div>
                  </div>
                </div>
              </div>
              <div class="tech-card p-3 rounded-lg" style="background-color: var(--bg);">
                <div class="flex items-center gap-2">
                  <span class="text-xl">📘</span>
                  <div>
                    <div class="font-semibold" style="color: var(--text);">TypeScript</div>
                    <div class="text-xs" style="color: var(--text-muted);">类型安全</div>
                  </div>
                </div>
              </div>
              <div class="tech-card p-3 rounded-lg" style="background-color: var(--bg);">
                <div class="flex items-center gap-2">
                  <span class="text-xl">🎨</span>
                  <div>
                    <div class="font-semibold" style="color: var(--text);">Tailwind CSS</div>
                    <div class="text-xs" style="color: var(--text-muted);">实用优先 CSS</div>
                  </div>
                </div>
              </div>
              <div class="tech-card p-3 rounded-lg" style="background-color: var(--bg);">
                <div class="flex items-center gap-2">
                  <span class="text-xl">🍍</span>
                  <div>
                    <div class="font-semibold" style="color: var(--text);">Pinia</div>
                    <div class="text-xs" style="color: var(--text-muted);">状态管理</div>
                  </div>
                </div>
              </div>
              <div class="tech-card p-3 rounded-lg" style="background-color: var(--bg);">
                <div class="flex items-center gap-2">
                  <span class="text-xl">🚀</span>
                  <div>
                    <div class="font-semibold" style="color: var(--text);">EdgeOne</div>
                    <div class="text-xs" style="color: var(--text-muted);">服务端引擎</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div class="feature-item flex items-center gap-3 p-3 rounded-lg" style="background-color: var(--bg);">
                <span class="text-2xl">💾</span>
                <div>
                  <div class="font-semibold" style="color: var(--text);">本地存储</div>
                  <div class="text-xs" style="color: var(--text-muted);">数据保存在浏览器，隐私安全</div>
                </div>
              </div>
              <div class="feature-item flex items-center gap-3 p-3 rounded-lg" style="background-color: var(--bg);">
                <span class="text-2xl">📱</span>
                <div>
                  <div class="font-semibold" style="color: var(--text);">响应式设计</div>
                  <div class="text-xs" style="color: var(--text-muted);">完美适配手机、平板、电脑</div>
                </div>
              </div>
              <div class="feature-item flex items-center gap-3 p-3 rounded-lg" style="background-color: var(--bg);">
                <span class="text-2xl">🎨</span>
                <div>
                  <div class="font-semibold" style="color: var(--text);">深色主题</div>
                  <div class="text-xs" style="color: var(--text-muted);">保护视力，舒适体验</div>
                </div>
              </div>
              <div class="feature-item flex items-center gap-3 p-3 rounded-lg" style="background-color: var(--bg);">
                <span class="text-2xl">📊</span>
                <div>
                  <div class="font-semibold" style="color: var(--text);">可视化报告</div>
                  <div class="text-xs" style="color: var(--text-muted);">直观了解测评结果</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div class="p-4 rounded-lg" style="background-color: var(--warning-bg); border-left: 4px solid var(--warning-border);">
            ...
            <p class="text-sm" style="color: var(--warning-text);">
              ...
              <br>• 希望24热线：400-161-9995（全国心理援助）
              <br>• 北京心理危机研究与干预中心：010-82951332
            </p>
          </div>
        </div>
      </div>
