...
export const scl90Dimensions = {
  somatization: {
    ...
    nameEn: 'Somatization',
    icon: '💪',
    description: '主要反映身体不适感，包括心血管、胃肠道、呼吸等系统的主诉不适，以及头痛、肌肉酸痛等其他躯体表现。',
  ...
  obsessive: {
    ...
    icon: '🔄',
    description: '指那些明知没有必要但又无法摆脱的思想、冲动和行为，以及一些一般的行为障碍症状。',
    highScore: '高分提示可能存在反复出现的不必要想法或行为，做事追求完美，难以做决定。',
  ...
  interpersonal: {
    ...
    icon: '👥',
    description: '主要指个人在人际交往中的不自在感和自卑感，特别是在与他人比较时更为突出。',
    highScore: '高分提示可能存在人际交往困扰，常感到不自在、自卑，过分在意他人评价。',
  ...
  depression: {
    ...
    nameEn: 'Depression',
    icon: '😔',
    description: '反映与临床抑郁症状相关的广泛问题，包括兴趣减退、缺乏活动动力、情绪低落等。',
  ...
  anxiety: {
    ...
    nameEn: 'Anxiety',
    icon: '😰',
    description: '指临床上与焦虑症状相关的表现，包括紧张、颤抖、惊恐发作等体验。',
  ...
  hostility: {
    ...
    nameEn: 'Hostility',
    icon: '😠',
    description: '反映个体在思维、情感及行为上的敌对表现，包括厌烦、争论、冲动等。',
  ...
  phobic: {
    ...
    icon: '😨',
    description: '指与特定情境或对象相关的恐惧反应，如空旷场所、社交场合、公共交通工具等。',
    highScore: '高分提示可能存在特定场所或对象的恐惧感，会主动回避令其害怕的情境。',
...
export const scl90DimensionLevels = [
  { min: 1, max: 1.5, level: '很低', description: '该维度状况很好，几乎没有问题' },
  { min: 1.5, max: 2, level: '较低', description: '该维度状况良好，问题较少' },
  { min: 2, max: 2.5, level: '中等', description: '该维度存在一定问题，值得关注' },
  { min: 2.5, max: 3.5, level: '较高', description: '该维度问题较明显，需要关注' },
  { min: 3.5, max: 5, level: '很高', description: '该维度问题严重，建议寻求专业帮助' }
]
...
// 计算维度均分的函数
export function calculateDimensionScores(answers: Record<number, number>): Record<string, { total: number; average: number; level: string; description: string }> {
  const dimensionScores: Record<string, { total: number; average: number; level: string; description: string }> = {}
