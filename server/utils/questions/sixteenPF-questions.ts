...
export const sixteenPFFactors = {
  ...
  B: {
    name: "聪慧性",
    nameEn: "Reasoning",
    highDesc: "聪明、富有才识、善于抽象思维",
    lowDesc: "思想迟钝、学识浅薄",
  },
  C: {
    name: "稳定性",
    nameEn: "Emotional Stability",
    highDesc: "情绪稳定而成熟，能面对现实",
    lowDesc: "情绪激动，易生烦恼",
  },
  E: {
    name: "恃强性",
  ...
  G: {
    name: "有恒性",
    nameEn: "Rule-Consciousness",
    highDesc: "有恒负责，做事尽职",
    lowDesc: "苟且敷衍，缺乏奉公守法精神",
  },
  H: {
    name: "敢为性",
...
export const sixteenPFQuestions = [
  ...
  {
    id: 13,
    text: "下列三个字中哪个字与其他两个字属于不同类别：狗、石、牛",
    factor: "B",
    reverse: false,
    optionType: "logic",
    options: [
  ...
  {
    id: 19,
    text: "下列数列中空缺的数字是什么：1、1、2、3、5、8、?",
    factor: "B",
    reverse: false,
    optionType: "logic",
    options: [
  ...
  {
    id: 23,
    text: "下列词语中哪个与其他不同类：高兴、悲伤、桌子、愤怒",
    factor: "B",
    reverse: false,
    optionType: "logic",
    options: [
  ...
  {
    id: 24,
    text: "下列数字中哪个与其他不同类：9、16、25、36、40",
    factor: "B",
    reverse: false,
    optionType: "logic",
    options: [
...
export function getOptionsForQuestion(
  question: (typeof sixteenPFQuestions)[0],
) {
  // 如果题目定义了自定义选项，优先使用
...
export function getCorrectAnswer(id: number): number | null {
  const question = sixteenPFQuestions.find((q) => q.id === id);
  const q = question as (typeof sixteenPFQuestions)[0] & {
