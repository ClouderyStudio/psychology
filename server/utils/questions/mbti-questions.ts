...
export const mbtiQuestions: MBTIQuestion[] = [
  ...
  {
    id: 1,
    text: "在朋友聚会或小组活动中，如果大家都沉默，我通常愿意先开口带动气氛",
    dimension: "EI",
    reverse: false,
  ...
  {
    id: 3,
    text: "如果一个任务可以选择独自完成或和几个人协作，我通常会选择一起推进",
    dimension: "EI",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 5,
    text: "周末有一个认识新朋友的活动时，只要状态允许，我通常会愿意去看看",
    dimension: "EI",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 9,
    text: "连续参加几场社交活动后，我通常需要独处一会儿才能恢复状态",
    dimension: "EI",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 11,
    text: "在多人聊天时，如果话题推进很快，我常会先听一阵再表达观点",
    dimension: "EI",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 17,
    text: "到了一个新环境后，我通常会主动认识身边的人或加入正在进行的交流",
    dimension: "EI",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 25,
    text: "听到一个新计划时，我会先问清楚具体步骤、时间和可验证的信息",
    dimension: "SN",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 27,
    text: "学习新东西时，我更喜欢先看到可操作的例子和实际用途",
    dimension: "SN",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 31,
    text: "接到任务时，如果要求比较模糊，我会希望对方补充明确标准和细节",
    dimension: "SN",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 35,
    text: "看到一个普通现象时，我常会忍不住想它未来可能发展成什么样",
    dimension: "SN",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 38,
    text: "如果旧方法能用但不够有趣，我会想试试有没有新的做法",
    dimension: "SN",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 42,
    text: "讨论方案时，我常能从别人没注意到的角度提出另一种可能",
    dimension: "SN",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 47,
    text: "当大家默认照旧处理时，我会想问一句“有没有完全不同的办法”",
    dimension: "SN",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 48,
    text: "面对重要选择时，我会先列出利弊、证据和后果，再考虑感受",
    dimension: "TF",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 50,
    text: "如果发现方案里有明显漏洞，即使气氛不错，我也会倾向于直接指出来",
    dimension: "TF",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 53,
    text: "别人请我提建议时，我会认为指出不足比只说好听的话更有帮助",
    dimension: "TF",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 59,
    text: "做决定前，如果会影响身边的人，我会先想他们可能有什么感受",
    dimension: "TF",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 61,
    text: "需要指出别人问题时，我会先斟酌措辞，避免让对方难堪",
    dimension: "TF",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 66,
    text: "讨论开始变得尖锐时，我通常会尝试缓和气氛或换一种说法",
    dimension: "TF",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 68,
    text: "团队要做取舍时，我会特别在意这个决定会不会让某些人被忽略",
    dimension: "TF",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 72,
    text: "遇到重要事项时，我会提前订时间、查资料或准备备用方案",
    dimension: "JP",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 74,
    text: "如果选项太多，我会希望尽快确定一个方向，而不是一直悬着",
    dimension: "JP",
    reverse: false,
    questionType: "scenario",
  },
  ...
  {
    id: 82,
    text: "面对还不确定的事情，我宁愿先保留几个选择，不急着定死",
    dimension: "JP",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 84,
    text: "临时出现有趣机会时，即使原计划要调整，我也愿意即兴跟上",
    dimension: "JP",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 88,
    text: "执行计划过程中，如果现场情况变化，我会自然地边走边调整",
    dimension: "JP",
    reverse: true,
    questionType: "scenario",
  },
  ...
  {
    id: 94,
    text: "如果临时被安排在小组汇报中开场，我通常能迅速进入表达状态",
    dimension: "EI",
    reverse: false,
    layer: "outer",
    questionType: "scenario",
  ...
  {
    id: 95,
    text: "结束一天的事务后，我更想留出一段不被打扰的时间整理自己",
    dimension: "EI",
    reverse: true,
    layer: "inner",
    questionType: "daily",
  ...
  {
    id: 96,
    text: "如果朋友临时邀请我参加陌生人的聚会，我通常会先评估这是否消耗精力",
    dimension: "EI",
    reverse: true,
    layer: "outer",
    questionType: "scenario",
  ...
  {
    id: 99,
    text: "我常在普通事件里联想到未来趋势、隐含意义或新的可能",
    dimension: "SN",
    reverse: true,
    layer: "inner",
    questionType: "daily",
  ...
  {
    id: 100,
    text: "做重要选择时，亲眼可见的数据和经验比灵感更让我安心",
    dimension: "SN",
    reverse: false,
    layer: "inner",
    questionType: "scenario",
  ...
  {
    id: 103,
    text: "做决定后，我仍会反复感受这个选择是否照顾到了重要的人",
    dimension: "TF",
    reverse: true,
    layer: "inner",
    questionType: "daily",
  ...
  {
    id: 108,
    text: "如果计划突然变化，我通常会先观察新机会，而不是急着恢复原计划",
    dimension: "JP",
    reverse: true,
    layer: "outer",
    questionType: "scenario",
