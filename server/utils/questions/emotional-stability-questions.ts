...
export const emotionalStabilityQuestions: EmotionalStabilityQuestion[] = [
  ...
  {
    id: 7,
    text: "若是遭到别人的侮辱，我的心情将久久不能平息，过了好多天仍不能忘记",
  },
...
export const stabilityLevels = [
  {
    ...
    max: 11,
    level: "不稳定",
    description: "情绪过敏，内心困扰，心情波动大",
  },
  {
    min: 12,
    max: 23,
    level: "不太稳定",
    description: "情绪经常波动，内心有困扰",
  },
  {
    min: 24,
    max: 36,
    level: "中等",
    description: "介于情绪敏感与情绪稳定之间",
  },
  {
    min: 37,
    max: 48,
    level: "较稳定",
    description: "情绪很少波动，有较稳定的态度和行动",
  },
  {
    min: 49,
    max: 60,
    level: "很稳定",
    description: "稳重、成熟、自信、理智、镇定",
  },
];
