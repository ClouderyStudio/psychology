...
export const temperamentQuestions: TemperamentQuestion[] = [
  ...
  {
    id: 17,
    text: "情绪高昂时，觉得干什么都有趣；情绪低落时，又觉得什么都没有意思",
    dimension: "choleric",
  },
  {
    id: 18,
    text: "当注意力集中于一事物时，别的事很难使我分心",
    dimension: "phlegmatic",
  },
  { id: 19, text: "理解问题总比别人快", dimension: "sanguine" },
  {
    id: 20,
    text: "碰到危险情景，常有一种极度恐怖感",
    dimension: "melancholic",
  },
  ...
  {
    id: 28,
    text: "爱看感情细腻、描写人物内心活动的文艺作品",
    dimension: "melancholic",
  },
  { id: 29, text: "工作学习时间长了，常感到厌倦", dimension: "sanguine" },
  {
    id: 30,
    text: "不喜欢长时间谈论一个问题，愿意实际动手干",
    dimension: "choleric",
  },
  ...
  {
    id: 37,
    text: "学习、工作同样一段时间后，常比别人更疲倦",
    dimension: "melancholic",
  },
  { id: 38, text: "做事有些莽撞，常常不考虑后果", dimension: "choleric" },
  {
    id: 39,
    text: "老师或他人讲授新知识、技术时，总希望他讲得慢些，多重复几遍",
    dimension: "phlegmatic",
  },
  { id: 40, text: "能够很快地忘记那些不愉快的事情", dimension: "sanguine" },
  {
    id: 41,
    text: "做作业或完成一件工作总比别人花的时间多",
    dimension: "phlegmatic",
  },
  {
    id: 42,
    text: "喜欢运动量大的剧烈体育运动，或者参加各种文艺活动",
    dimension: "choleric",
  },
  {
    id: 43,
