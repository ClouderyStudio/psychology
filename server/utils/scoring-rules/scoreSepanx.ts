// 分离焦虑障碍严重度（DSM-5-TR 成人严重度10题，0-4 求和）· 计分
...
export function scoreSepanx(answers: Record<number, number>): ScoringResult {
  let total = 0;
  ...
  const suggestion = "【分离焦虑障碍严重度】总分 " + total + " / 40（10题，0-4 分/题）\\n"
    + "参考等级：" + level + "（按平均分 " + avg + " / 4 定档）。平均分 <0.5 无/亚临床、<1.5 轻度、<2.5 中度、<3.5 重度、≥3.5 极重度\\n\\n"
    + "参考说明：" + "本量表为分离焦虑障碍成人严重度量表（DSM-5-TR）。评估过去 7 天对与重要的人或家分离时的恐惧、担忧、躯体反应与回避。\\n"
    + "若分离焦虑明显干扰工作、出行或重要关系，请寻求专业评估。\\n"
