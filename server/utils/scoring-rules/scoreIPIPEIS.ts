import {
  ipipEisDimensionKeys,
  ipipEisQuestions,
  ipipEisDimensions,
} from "../questions/ipip-eis-questions";

// IPIP-EIS 评分函数
export function scoreIPIPEIS(answers: Record<number, number>): ScoringResult {
  const dimensions = ipipEisDimensionKeys;
  const dimScores: Record<
    string,
    { total: number; count: number; raw: number }
  > = {};
  ...
  // 生成报告
  const suggestion = generateIPIPEISReport(
    dimAverages,
    dimRawAverages,
    isValid,
    lieAvg,
  ...
  return {
    ...
    dimensionScores: {
      ...
      dimensions: {
        positive_express: {
          score: dimAverages.positive_express,
          raw: dimRawAverages.positive_express,
          name: ipipEisDimensions.positive_express.name,
          desc: ipipEisDimensions.positive_express.desc,
        },
        negative_express: {
          score: dimAverages.negative_express,
          raw: dimRawAverages.negative_express,
          name: ipipEisDimensions.negative_express.name,
          desc: ipipEisDimensions.negative_express.desc,
        },
        attention: {
          score: dimAverages.attention,
          raw: dimRawAverages.attention,
          name: ipipEisDimensions.attention.name,
          desc: ipipEisDimensions.attention.desc,
        },
        emotional_decision: {
          score: dimAverages.emotional_decision,
          raw: dimRawAverages.emotional_decision,
          name: ipipEisDimensions.emotional_decision.name,
          desc: ipipEisDimensions.emotional_decision.desc,
        },
        reactive_joy: {
          score: dimAverages.reactive_joy,
          raw: dimRawAverages.reactive_joy,
          name: ipipEisDimensions.reactive_joy.name,
          desc: ipipEisDimensions.reactive_joy.desc,
        },
        reactive_sadness: {
          score: dimAverages.reactive_sadness,
          raw: dimRawAverages.reactive_sadness,
          name: ipipEisDimensions.reactive_sadness.name,
          desc: ipipEisDimensions.reactive_sadness.desc,
        },
        empathy: {
          score: dimAverages.empathy,
          raw: dimRawAverages.empathy,
          name: ipipEisDimensions.empathy.name,
          desc: ipipEisDimensions.empathy.desc,
        },
      },
    },
  };
...
function generateIPIPEISReport(
  ...
  if (!isValid) {
    report +=
      "⚠️ 注意：您的测谎题得分偏高，本次结果可能受到答题态度影响，建议重新认真作答。\n\n";
  }
