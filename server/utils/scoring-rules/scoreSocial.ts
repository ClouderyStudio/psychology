// 社交焦虑障碍严重度（DSM-5-TR 成人严重度10题，0-4 求和）· 计分
...
export function scoreSocial(answers: Record<number, number>): ScoringResult {
  let total = 0;
  ...
  const suggestion = "【社交焦虑障碍严重度】总分 " + total + " / 40（10题，0-4 分/题）\\n"
    + "参考等级：" + level + "（按平均分 " + avg + " / 4 定档）。平均分 <0.5 无/亚临床、<1.5 轻度、<2.5 中度、<3.5 重度、≥3.5 极重度\\n\\n"
    + "参考说明：" + "本量表为社交焦虑障碍（社交恐怖）成人严重度量表（DSM-5-TR）。评估过去 7 天在公开讲话、聚会、交谈等社交情境中的焦虑、躯体反应与回避。\\n"
    + "若社交场合的焦虑明显妨碍学习、工作与人际，请寻求专业评估。\\n"
