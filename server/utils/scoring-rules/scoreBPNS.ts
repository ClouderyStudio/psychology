...
export function scoreBPNS(answers: Record<number, number>): ScoringResult {
  ...
  return {
    ...
    dimensionScores: {
      autonomy: {
        score: dimAverages.autonomy,
        level: dimLevels.autonomy,
        desc: bpnsDimensions.autonomy.desc,
      },
      competence: {
        score: dimAverages.competence,
        level: dimLevels.competence,
        desc: bpnsDimensions.competence.desc,
      },
      relatedness: {
        score: dimAverages.relatedness,
        level: dimLevels.relatedness,
        desc: bpnsDimensions.relatedness.desc,
      },
    },
  };
}
