// 广场恐怖严重度（DSM-5-TR 成人严重度10题，0-4 求和）· 计分
...
export function scoreAgora(answers: Record<number, number>): ScoringResult {
  let total = 0;
  ...
  const suggestion = "【广场恐怖严重度】总分 " + total + " / 40（10题，0-4 分/题）\\n"
    + "参考等级：" + level + "（按平均分 " + avg + " / 4 定档）。平均分 <0.5 无/亚临床、<1.5 轻度、<2.5 中度、<3.5 重度、≥3.5 极重度\\n\\n"
    + "参考说明：" + "本量表为广场恐怖成人严重度量表（DSM-5-TR）。评估过去 7 天在人群、公共场所、乘坐交通工具、独自出行或离家等情境中的恐惧与回避。\\n"
    + "若因害怕难以离开或独自外出而限制日常活动，请寻求专业评估。\\n"
