import { getQuestionFactor, getCorrectAnswer, isReverseQuestion, sixteenPFFactors } from "#imports";
...
// 生成16PF综合报告
function generateSixteenPFReport(scores: Record<string, number>, secondary: Record<string, any>): string {
