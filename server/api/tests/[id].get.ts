...
import { bdcOptions, bdcQuestions } from '~~/server/utils/questions/bdc-questions'
import { bpnsOptions, bpnsQuestions } from '~~/server/utils/questions/bpns-questions'
import { emotionalStabilityOptions, emotionalStabilityQuestions } from '~~/server/utils/questions/emotional-stability-questions'
import { epqOptions, epqQuestions } from '~~/server/utils/questions/epq-questions'
import { epqRscOptions, epqRscQuestions } from '~~/server/utils/questions/epq-rsc-questions'
import { ipipEisQuestions, ipipEisOptions } from '~~/server/utils/questions/ipip-eis-questions'
import { mbtiOptions, mbtiQuestions } from '~~/server/utils/questions/mbti-questions'
import { sccsOptions, sccsQuestions } from '~~/server/utils/questions/sccs-questions'
import { getOptionsForQuestion, sixteenPFQuestions } from '~~/server/utils/questions/sixteenPF-questions'
import { temperamentOptions, temperamentQuestions } from '~~/server/utils/questions/temperament-questions'
...
export default defineEventHandler(async (event) => {
  ...
  const testDatabase: Record<string, Test> = {
    ...
    bpns: {
      id: 'bpns',
      title: '基本心理需求满足量表',
      description: '本量表基于自我决定理论，帮助您了解在自主、胜任和归属三个方面的心理需求满足程度。',
      instructions: '请根据您过去一周的真实感受，选择最符合的选项。每题有7个选项：从"完全不符合"到"完全符合"。共21题，大约需要3-5分钟。',
    ...
    'ipip-eis': {
      id: 'ipip-eis',
      title: '情绪智力量表',
      description: '本量表基于国际人格项目库(IPIP)开发，用于评估个体的情绪智力水平，包括情绪表达、注意、决策和共情等方面。',
      instructions: '请根据您的真实情况，选择最符合的选项。每题有5个选项：从"非常不符合"到"非常符合"。共64题，大约需要8-12分钟。量表包含2道测标题，请认真作答。',
